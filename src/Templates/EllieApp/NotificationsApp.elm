module Main exposing (Model, Msg(..), biggerButton, init, main, smallerButton, update, view)

import GraphicSVG exposing (..)
import GraphicSVG.EllieApp exposing (GetKeyState, NotificationsApp, notificationsApp)
